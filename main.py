from extractors import saatchi_artworks, saatchi_artists
from infra import gcp

# saatchi_artworks.get_all_artworks_info('art_data_files', 'saatchi_artworks_links.txt', 'saatchi_artworks_info.csv', 'saatchi_failed_artworks_urls.json')
